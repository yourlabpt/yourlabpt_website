...
const translations = {
    en: {
        // Document
        pageTitle: 'YourLab — Systems and apps built around your business',
        metaDescription: 'We build the system or app your business needs. Fixed quote before we start, and you follow the project on our own platform. Portugal and Europe.',

        // Header
        headerCta: 'Talk to us',

        // 1. Hero
        heroH1: 'A system built for your business. No commitment to start.',
        heroSub: "Tell us what gets in the way day to day. We tell you what's worth building, what it costs and when it's ready — before any decision.",
        heroCtaPrimary: 'I want to talk about my case',
        heroCtaSecondary: "See what we've built",
        heroMicrocopy: 'First conversation is free. If building makes no sense, we tell you.',

        // 2. Situations
        situationsH2: 'Which one is your case?',
        situation1Title: "You have an idea and don't know where to start",
        situation1Body: 'You know the problem you want to solve, but not what to build first, what it costs, or how long it takes. We define the first version and test it with real people.',
        situation2Title: 'You started building with AI and got stuck',
        situation2Body: "The first version came out fast. Now the same errors keep coming back, nothing works outside your own computer, and nobody can explain what's inside. We sort out what's there and get it running.",
        situation3Title: 'The company grew and the work is scattered',
        situation3Body: 'Excel, WhatsApp and email. The team copies the same data twice, reports are built by hand, and nobody sees the whole operation. We bring it into one system.',
        situationsClose: 'In all three cases the first step is the same: properly understanding what needs to happen.',
        situationCta: 'Talk about this →',
        prodAEyebrow: 'REAL CASE · RESTAURANTS',
        prodAH2: 'Tips split to the cent. Money from every source in one daily close.',
        prodABody1: "An internal app for restaurants that brings together cash, card terminal, MB Way and delivery apps, works out each role's share and closes the day without spreadsheets.",
        prodAPoint1: 'Daily close per restaurant, in two minutes',
        prodAPoint2: 'Split rules per role and per venue',
        prodAPoint3: 'Calculation source kept separate from payment source',
        prodAPoint4: 'Period settlement and reports for the owner',
        prodANote: 'In daily use across a restaurant group in Lisbon.',
        prodACta: 'I run a restaurant. I want this.',
        mkACloseTitle: 'Daily close',
        mkACash: 'Cash',
        mkACard: 'Card / terminal',
        mkADelivery: 'Glovo · Uber Eats',
        mkATips: "Today's tips",
        mkARoom: 'Floor · 45%',
        mkAKitchen: 'Kitchen · 35%',
        mkABar: 'Bar · 20%',
        mkAClose: 'Close the day',
        prodBEyebrow: 'INCLUDED WITH EVERY PROJECT',
        prodBH2: 'Watch your project move. Approve each step before we go on.',
        prodBBody1: "Any service you contract with us comes with access to our platform. You always know which phase we're in, what's left, and what's ready for your approval.",
        prodBPoint1: 'Mockups to approve before we build',
        prodBPoint2: 'Written requirements, not lost conversations',
        prodBPoint3: 'Deliveries per phase, each with your sign-off',
        prodBPoint4: 'Decisions on record — never again "who said that?"',
        prodBNote: 'This is where we fully control what AI does: every step it takes is on record, and nothing moves forward without a person seeing and approving it.',
        prodBCta: 'I want this for my project',
        mkBProject: 'Online bookings — Café Central',
        mkBPhase: 'Phase 3 of 5',
        mkBNextLabel: 'Next action — yours',
        mkBNext: 'Approve the booking screen mockup',
        mkBApprove: 'Approve',
        mkBChange: 'Request a change',
        mkBItem1: 'Mockup — booking screen',
        mkBItem2: 'Requirements v1',
        mkBItem3: 'Initial survey',
        mkBPending: 'to approve',
        mkBApproved: 'approved',
        // 5. How we work
        ...
        processAnchor: 'Every step produces something concrete to see, test and approve. The system and the code are yours — no dependency on us.',
        ...
        // 10. Invitation
        chatHeading: 'Tell us your case. No commitment.',
    ...
    pt: {
        // Documento
        pageTitle: 'YourLab — Sistemas e aplicações à medida do seu negócio',
        metaDescription: 'Construímos o sistema ou a aplicação que o seu negócio precisa. Orçamento fechado antes de começar, acompanhamento do projeto numa plataforma própria. Portugal e Europa.',

        // Header
        headerCta: 'Falar connosco',

        // 1. Hero
        heroH1: 'Um sistema feito para o seu negócio. Sem compromisso para começar.',
        heroSub: 'Diga-nos o que atrapalha o dia a dia. Nós dizemos o que faz sentido construir, quanto custa e quando fica pronto — antes de qualquer decisão.',
        heroCtaPrimary: 'Quero falar sobre o meu caso',
        heroCtaSecondary: 'Ver o que já construímos',
        heroMicrocopy: 'Primeira conversa gratuita. Se não fizer sentido construir, dizemos-lhe isso.',

        // 2. Situações reconhecíveis
        situationsH2: 'Qual destes é o seu caso?',
        situation1Title: 'Tem uma ideia e não sabe por onde começar',
        situation1Body: 'Sabe o problema que quer resolver, mas não sabe o que construir primeiro, quanto custa nem quanto demora. Definimos a primeira versão e testamo-la com pessoas reais.',
        situation2Title: 'Começou a construir com IA e ficou preso',
        situation2Body: 'A primeira versão saiu depressa. Agora há erros que voltam, nada funciona fora do seu computador e ninguém explica o que está lá dentro. Arrumamos o que existe e deixamos a funcionar.',
        situation3Title: 'A empresa cresceu e o trabalho ficou espalhado',
        situation3Body: 'Excel, WhatsApp e e-mail. A equipa copia os mesmos dados, os relatórios são feitos à mão e ninguém vê a operação toda. Juntamos isso num sistema só.',
        situationsClose: 'Em qualquer destes casos, o primeiro passo é o mesmo: entender bem o que precisa de acontecer.',
        situationCta: 'Falar sobre isto →',
        prodAEyebrow: 'CASO REAL · RESTAURAÇÃO',
        prodAH2: 'Gorjetas divididas ao cêntimo. Dinheiro de todas as fontes num só fecho.',
        prodABody1: 'Uma app interna para restaurantes que junta dinheiro, TPA, MB Way e apps de entrega, calcula a parte de cada função e fecha o dia sem folhas de cálculo.',
        prodAPoint1: 'Fecho diário por restaurante, em dois minutos',
        prodAPoint2: 'Regras de divisão por função e por casa',
        prodAPoint3: 'Fonte de cálculo separada da fonte de pagamento',
        prodAPoint4: 'Acerto por período e relatórios para o dono',
        prodANote: 'Em uso todos os dias numa rede de restaurantes em Lisboa.',
        prodACta: 'Tenho um restaurante. Quero isto.',
        mkACloseTitle: 'Fecho do dia',
        mkACash: 'Dinheiro',
        mkACard: 'Multibanco / TPA',
        mkADelivery: 'Glovo · Uber Eats',
        mkATips: 'Gorjetas do dia',
        mkARoom: 'Sala · 45%',
        mkAKitchen: 'Cozinha · 35%',
        mkABar: 'Bar · 20%',
        mkAClose: 'Fechar o dia',
        prodBEyebrow: 'INCLUÍDO EM TODOS OS PROJETOS',
        prodBH2: 'Vê o seu projeto a avançar. Aprova cada passo antes de avançarmos.',
        prodBBody1: 'Qualquer serviço que contrate connosco vem com acesso à nossa plataforma. Sabe sempre em que fase estamos, o que falta e o que já está pronto para aprovar.',
        prodBPoint1: 'Maquetes para aprovar antes de construirmos',
        prodBPoint2: 'Requisitos escritos, não conversas perdidas',
        prodBPoint3: 'Entregas por fase, com a sua aprovação em cada uma',
        prodBPoint4: 'Decisões registadas — nunca mais "quem disse isto?"',
        prodBNote: 'É aqui que controlamos totalmente o que a IA faz: cada passo que ela dá fica registado, e nada avança sem uma pessoa ver e aprovar.',
        prodBCta: 'Quero ver isto com o meu projeto',
        mkBProject: 'Reservas online — Café Central',
        mkBPhase: 'Fase 3 de 5',
        mkBNextLabel: 'Próxima ação — sua',
        mkBNext: 'Aprovar a maquete do ecrã de reservas',
        mkBApprove: 'Aprovar',
        mkBChange: 'Pedir alteração',
        mkBItem1: 'Maquete — ecrã de reservas',
        mkBItem2: 'Requisitos v1',
        mkBItem3: 'Levantamento inicial',
        mkBPending: 'para aprovar',
        mkBApproved: 'aprovado',
        // 5. Como trabalhamos
        ...
        processAnchor: 'Em cada passo há algo concreto para ver, testar e aprovar. O sistema e o código ficam seus — sem dependência de nós.',
        ...
        // 10. Convite final
        chatHeading: 'Diga-nos o seu caso. Sem compromisso.',
